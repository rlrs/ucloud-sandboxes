...
| 17 | P2 | complete | Successful image-build exit codes deserialize as missing. | Select snake/camel-case fields by presence so integer zero survives round trips. | `fix: preserve successful image build exit codes` |
