...
def render_remote_deploy_script(
    ...
    *,
    ...
    script_parts = [
        ...
        "    if sidecars:",
        "        build_manifest = direct_runsc.parent / 'build-manifest.json'",
        "        manifest_payload['runtime']['direct_runsc']['build_manifest'] = {'file': 'runtime/direct/build-manifest.json', 'size': build_manifest.stat().st_size, 'sha256': sha256_file(build_manifest)}",
        ...
        "                if sidecars:",
        "                    archive_paths.append((direct_runsc.parent / 'build-manifest.json', 'runtime/direct/build-manifest.json'))",
